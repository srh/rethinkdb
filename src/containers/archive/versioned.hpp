    ...
    *thing = cluster_version_t::LATEST_OVERALL;
    ...
    if (raw == static_cast<int8_t>(obsolete_cluster_version_t::v1_13)
        ...
        if ((raw >= static_cast<int8_t>(cluster_version_t::v1_14)
             && raw <= static_cast<int8_t>(cluster_version_t::v2_4))
            || (raw == static_cast<int8_t>(cluster_version_t::v2_4_ext_is_latest))) {
...
archive_result_t deserialize_for_version(cluster_version_t version,
    ...
    case cluster_version_t::v2_4_ext_is_latest:
        return deserialize<cluster_version_t::v2_4_ext_is_latest>(s, thing);
    default:
...
size_t serialized_size_for_version(cluster_version_t version,
    ...
    case cluster_version_t::v2_4_ext_is_latest:
        return serialized_size<cluster_version_t::v2_4_ext_is_latest>(thing);
    default:
